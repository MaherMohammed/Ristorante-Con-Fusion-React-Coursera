...
class Contact extends Component{
    ...
    constructor(props){
        super(props);
        this.state = {
            //the linked feilds that is related to our controlled form
            firstname:'',
            lastname:'',
            telnum:'',
            email:'',
    ...
    handleInputChange(event){
        // get the nme of the targetted input
    ...
    validate(firstname, lastname, telnum, email){
        ...
        // this regular expression ensures that all chars are numbers not letters
        const reg = /^\d+$/;
